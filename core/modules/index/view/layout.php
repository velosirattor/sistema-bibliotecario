    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./">Sistema  <sup><small><span class="label label-info">  Bibliotecario</span></small></sup> </a>
        </div>
...
if(Session::getUID()!=""){
  ...
  $user = $u->name." ".$u->lastname;
        ...
        <b><u>INTECNA</u></b> <b class="caret"></b>
        </a>
        <ul class="dropdown-menu">
          <li><a target="_blank" href="https://www.tecnacional.edu.ni/centro/intecna-granada/">SITIO WEB INTECNA</a></li>
